...
static bool test_hostname_extraction_overflow(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(long_hostname, sizeof(long_hostname), 'a', 255) == 0,
                "mtls_memset_s should succeed for long_hostname");
    long_hostname[255] = ':';
    long_hostname[256] = '8';
    long_hostname[257] = '0';
    long_hostname[258] = '8';
    ...
    TEST_ASSERT(err.code == MTLS_ERR_INVALID_ADDRESS || err.code == MTLS_ERR_HOSTNAME_MISMATCH,
...
static bool test_address_string_validation(void)
{
    ...
    char long_addr[600];
    TEST_ASSERT(mtls_memset_s(long_addr, sizeof(long_addr), 'a', 513) == 0,
                "mtls_memset_s should succeed for long_addr");
    long_addr[513] = ':';
    long_addr[514] = '8';
    long_addr[515] = '0';
    long_addr[516] = '8';
    ...
    TEST_ASSERT(err.code == MTLS_ERR_INVALID_ADDRESS, "Should return invalid address error");
...
static bool test_port_number_validation(void)
{
    ...
    if (!ctx) {
        return true;
    } /* Context creation may fail with invalid PEM, but validation logic is tested */

    /* Test with invalid port numbers */
    const mtls_conn *conn = NULL;
...
static bool test_file_path_validation(void)
{
    ...
    char long_path[4100];
    TEST_ASSERT(mtls_memset_s(long_path, sizeof(long_path), 'a', 4097) == 0,
                "mtls_memset_s should succeed for long_path");
    long_path[4097] = '\0';
    ...
    TEST_ASSERT(err.code == MTLS_ERR_INVALID_CONFIG, "Should return invalid config error");
...
static bool test_pem_data_validation(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(large_pem, sizeof(large_pem), 'A', sizeof(large_pem)) == 0,
                "mtls_memset_s should succeed for large_pem");
...
static bool test_allowed_sans_validation(void)
{
    ...
    char long_san[514];
    TEST_ASSERT(mtls_memset_s(long_san, sizeof(long_san), 'a', 513) == 0,
                "mtls_memset_s should succeed for long_san");
    long_san[513] = '\0';
...
static bool test_buffer_size_limits(void)
{
    ...
    TEST_ASSERT(MTLS_MAX_READ_BUFFER_SIZE <= 1024 * 1024,
                "MAX_READ_BUFFER_SIZE should be reasonable");
    TEST_ASSERT(MTLS_MAX_WRITE_BUFFER_SIZE <= 1024 * 1024,
                "MAX_WRITE_BUFFER_SIZE should be reasonable");
...
static bool test_error_message_null_termination(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(long_msg, sizeof(long_msg), 'A', sizeof(long_msg) - 1) == 0,
                "mtls_memset_s should succeed for long_msg");
...
static bool test_edge_case_buffer_boundaries(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(hostname_255, sizeof(hostname_255), 'a', 255) == 0,
                "mtls_memset_s should succeed for hostname_255");
    hostname_255[255] = ':';
    hostname_255[256] = '8';
    hostname_255[257] = '0';
    hostname_255[258] = '8';
    ...
    char addr_512[520];
    TEST_ASSERT(mtls_memset_s(addr_512, sizeof(addr_512), 'a', 512) == 0,
                "mtls_memset_s should succeed for addr_512");
    addr_512[512] = ':';
    addr_512[513] = '8';
    addr_512[514] = '0';
    addr_512[515] = '8';
    ...
    char addr_513[521];
    TEST_ASSERT(mtls_memset_s(addr_513, sizeof(addr_513), 'a', 513) == 0,
                "mtls_memset_s should succeed for addr_513");
    addr_513[513] = ':';
    addr_513[514] = '8';
    addr_513[515] = '0';
    addr_513[516] = '8';
...
static bool test_edge_case_file_path_boundaries(void)
{
    ...
    char path_4096[4097];
    TEST_ASSERT(mtls_memset_s(path_4096, sizeof(path_4096), 'a', 4096) == 0,
                "mtls_memset_s should succeed for path_4096");
    path_4096[4096] = '\0';
    ...
    char path_4097[4098];
    TEST_ASSERT(mtls_memset_s(path_4097, sizeof(path_4097), 'a', 4097) == 0,
                "mtls_memset_s should succeed for path_4097");
    path_4097[4097] = '\0';
...
static bool test_edge_case_pem_boundaries(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(pem_1mb, sizeof(pem_1mb), 'A', sizeof(pem_1mb)) == 0,
                "mtls_memset_s should succeed for pem_1mb");
    ...
    TEST_ASSERT(mtls_memset_s(pem_1mb_plus, sizeof(pem_1mb_plus), 'A', sizeof(pem_1mb_plus)) == 0,
                "mtls_memset_s should succeed for pem_1mb_plus");
...
static bool test_edge_case_san_boundaries(void)
{
    ...
    char san_512[513];
    TEST_ASSERT(mtls_memset_s(san_512, sizeof(san_512), 'a', 512) == 0,
                "mtls_memset_s should succeed for san_512");
    san_512[512] = '\0';
    ...
    char san_513[514];
    TEST_ASSERT(mtls_memset_s(san_513, sizeof(san_513), 'a', 513) == 0,
                "mtls_memset_s should succeed for san_513");
    san_513[513] = '\0';
...
static bool test_edge_case_write_buffer_limits(void)
{
    ...
    TEST_ASSERT(MTLS_MAX_WRITE_BUFFER_SIZE <= 1024 * 1024,
                "Write buffer limit should be reasonable");
...
static bool test_edge_case_int_max_boundary(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(small_pem, sizeof(small_pem), 'A', sizeof(small_pem)) == 0,
                "mtls_memset_s should succeed for small_pem");
...
static bool test_edge_case_error_truncation(void)
{
    ...
    TEST_ASSERT(mtls_memset_s(exact_fit, sizeof(exact_fit), 'A', MTLS_ERR_MESSAGE_SIZE - 1) == 0,
                "mtls_memset_s should succeed for exact_fit");
    ...
    TEST_ASSERT(mtls_memset_s(too_long, sizeof(too_long), 'B', sizeof(too_long) - 1) == 0,
                "mtls_memset_s should succeed for too_long");
