...
typedef enum mtls_event_type {
    ...
    MTLS_EVENT_POOL_ACQUIRE_START = 40,
    MTLS_EVENT_POOL_ACQUIRE_SUCCESS = 41,
    MTLS_EVENT_POOL_ACQUIRE_TIMEOUT = 42,
    MTLS_EVENT_POOL_RELEASE = 43,
    MTLS_EVENT_POOL_CONN_CREATED = 44,
    MTLS_EVENT_POOL_CONN_CLOSED = 45,

    /* Async I/O events (50-53) */
    MTLS_EVENT_ASYNC_CONNECT_START = 50,
    MTLS_EVENT_ASYNC_CONNECT_SUCCESS = 51,
    MTLS_EVENT_ASYNC_CONNECT_FAILURE = 52,
    MTLS_EVENT_ASYNC_OP_CANCELLED = 53,
