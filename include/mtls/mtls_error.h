...
typedef enum mtls_error_code {
    ...
    MTLS_ERR_HSM_INIT_FAILED = 111,
    MTLS_ERR_HSM_PIN_REQUIRED = 112,
    MTLS_ERR_HSM_PIN_INVALID = 113,
    MTLS_ERR_HSM_KEY_NOT_FOUND = 114,
    MTLS_ERR_HSM_OPERATION_FAILED = 115,
    MTLS_ERR_HSM_SLOT_NOT_FOUND = 116,
    MTLS_ERR_HSM_MODULE_NOT_FOUND = 117,
    ...
    MTLS_ERR_POOL_EXHAUSTED = 212,
    MTLS_ERR_POOL_ACQUIRE_TIMEOUT = 213,
    MTLS_ERR_POOL_CLOSED = 214,
    MTLS_ERR_CONN_UNHEALTHY = 215,
    ...
    MTLS_ERR_OCSP_FAILED = 313,
    MTLS_ERR_OCSP_TIMEOUT = 314,
    MTLS_ERR_OCSP_RESPONDER_ERROR = 315,
    MTLS_ERR_CRL_FAILED = 316,
    MTLS_ERR_CRL_DOWNLOAD_FAILED = 317,
    MTLS_ERR_CRL_EXPIRED = 318,
    MTLS_ERR_CRL_PARSE_FAILED = 319,
    MTLS_ERR_PIN_VALIDATION_FAILED = 320,
    MTLS_ERR_PIN_INVALID_FORMAT = 321,
    MTLS_ERR_PIN_COMPUTE_FAILED = 322,
    MTLS_ERR_CT_VALIDATION_FAILED = 323,
    MTLS_ERR_CT_NO_SCTS = 324,
    MTLS_ERR_CT_INSUFFICIENT_SCTS = 325,
    MTLS_ERR_CT_INVALID_SCT = 326,
    MTLS_ERR_CT_UNKNOWN_LOG = 327,
    MTLS_ERR_CT_LOG_LIST_PARSE = 328,
    ...
    MTLS_ERR_RATE_LIMITED = 503,
    MTLS_ERR_RATE_LIMIT_GLOBAL = 504,
    MTLS_ERR_RATE_LIMIT_CLIENT = 505,
...
/*
 * Error category boundary constants
 */
typedef enum mtls_error_category_boundary {
    MTLS_ERR_CAT_CONFIG_MIN = 100,
    MTLS_ERR_CAT_CONFIG_MAX = 200,
    MTLS_ERR_CAT_NETWORK_MIN = 200,
    MTLS_ERR_CAT_NETWORK_MAX = 300,
    MTLS_ERR_CAT_TLS_MIN = 300,
    MTLS_ERR_CAT_TLS_MAX = 400,
    MTLS_ERR_CAT_IDENTITY_MIN = 400,
    MTLS_ERR_CAT_IDENTITY_MAX = 500,
    MTLS_ERR_CAT_POLICY_MIN = 500,
    MTLS_ERR_CAT_POLICY_MAX = 600,
    MTLS_ERR_CAT_IO_MIN = 600,
    MTLS_ERR_CAT_IO_MAX = 700
} mtls_error_category_boundary_t;
